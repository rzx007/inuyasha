import { resolveVariablesInConfig as resolveVariablesInConfigCore } from '@inuyasha/core/expression'
...
export function useResolveVariablesInConfig() {
  ...
  return (config: ApiDataSourceConfig) => resolveVariablesInConfigCore(config, context.value)
}
